    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <article className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="max-w-3xl mx-auto bg-white p-8 md:p-12 rounded-xl shadow-sm border border-gray-100">
          ...
          <div
            className="prose prose-lg prose-slate prose-headings:text-slate-900 prose-a:text-secondary-600 hover:prose-a:text-secondary-700 prose-img:rounded-xl prose-img:cursor-zoom-in prose-strong:text-slate-900 font-serif leading-loose text-slate-700"
