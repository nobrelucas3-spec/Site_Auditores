...
export const MOCK_NEWS: NewsItem[] = [
  {
    ...
    date: '2026-05-25',
    imageUrl: '/news/protecao-dinheiro-publico.png',
    ...
    content: `
      <div class="mb-8">
        <img src="/news/protecao-dinheiro-publico.png" alt="O papel do Auditor de Controle Externo na proteção do dinheiro público" class="w-full h-auto rounded-xl shadow-lg border border-gray-100" />
      </div>
...
export const PHOTO_ALBUMS = [
  {
    ...
    photos: [
      ...
      '/gallery/dia-do-auditor-2026/foto2.jpg',
      '/gallery/dia-do-auditor-2026/foto3.jpg',
      '/gallery/dia-do-auditor-2026/foto4.jpg',
      '/gallery/dia-do-auditor-2026/foto5.jpg'
    ]
  }
];